...
## Build dirs
srcdir = os.path.abspath("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/src")
libdir = os.path.abspath("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/src/.libs")
incdirs = [os.path.abspath("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/include"),
           os.path.abspath("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/include")]

## The extension source file (built by separate Cython call)
srcname = "lhapdf.cpp"
srcpath = os.path.join("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/wrappers/python", srcname)
if not os.path.isfile(srcpath): # distcheck has it in srcdir
    srcpath = os.path.join("/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/wrappers/python", srcname)

## Include args
incargs = " ".join("-I{}".format(d) for d in incdirs)
incargs += " -I/home/stricklandlab/LHAPDF/LHAPDF_install/include"
incargs += "  -I/home/stricklandlab/LHAPDF/LHAPDF_install/include"
...
linkargs = " -L/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/src/.libs" if "LHAPDF_LOCAL" in os.environ else "-L/home/stricklandlab/LHAPDF/LHAPDF_install/lib"
linkargs += "  -L/home/stricklandlab/LHAPDF/LHAPDF_install/lib"
...
import subprocess
sys.exit(subprocess.call(compile_cmd.split(), cwd="/home/stricklandlab/LHAPDF/LHAPDF-6.5.4/wrappers/python/build/lhapdf"))
